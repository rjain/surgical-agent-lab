...
#: Set by numpy 2.5.2 (>=3.12), found by checking every pin rather than the
#: obvious ones: google-adk says >=3.10, pandas says >=3.11, and both of those
#: answers were shipped and were wrong. CI tests 3.12.
MIN_PYTHON = (3, 12)
STREAMLIT_PORT = 8501
